...
from queries.project_stacks import ProjectStackIn, ProjectStackOut, ProjectStacksRepository, Error
...
@router.put("/api/project-stacks/{project_stack_id}", response_model=Union[ProjectStackOut, Error])
...
@router.get("/api/project-stacks/{project_stack_id}", response_model=Optional[ProjectStackOut])
...
@router.post("/api/project-stacks", response_model=Union[ProjectStackOut, Error])
